    ...
    return (
      <>
        ...
        <section className="rounded-lg border border-amber-200 bg-amber-50 p-6 shadow-sm">
          ...
          <a href="/session" className="mt-3 inline-flex min-h-10 items-center rounded-md bg-amber-700 px-4 py-2 text-sm font-medium text-white hover:bg-amber-800">Start your first session</a>
        </section>
      </>
    );
  }
    ...
    <>
      ...
      <section className="mb-6 grid gap-4 md:grid-cols-3">
        <article className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm md:col-span-2">
          ...
          <a href="/session" className="mt-4 inline-flex min-h-10 items-center rounded-md bg-slate-900 px-5 py-2 text-sm font-semibold text-white hover:bg-slate-700">Start session</a>
        </article>
